...
export const qk = {
  ...
  progress: {
    ...
    noteSummary: ['progress', 'note-summary'] as const,
  ...
  contentRights: {
    ...
    publications: (params?: unknown) => ['content-rights', 'publications', params ?? {}] as const,
    targets: ['content-rights', 'targets'] as const,
  },
  moderation: {
